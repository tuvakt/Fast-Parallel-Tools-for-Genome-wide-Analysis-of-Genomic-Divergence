...
/* Tests 
   ...
   - choice of distance metric (0: count differences, 1: frequency)
   - choice of mds algorithm (0: classical mds, 1: smacof, 2: smacof + cmds)
...
/* test if the results from the parallel and serial program are the same */
...
void test_all(int argc, char *argv[]) {
    ...
    threadcompute(avals, bvals, apos, bpos, 0, (apos[acount-1]+1), wsize, wstep, acount, bcount, treshold, runs, drosophila, mds, scores, p);
...
int main(int argc, char **argv) {
    ...
    /* test for inlined functions, unncommented */

...
//	}
	...
	compute(avals, bvals, apos, bpos, 0, (apos[acount-1]+1), wsize, wstep, acount, bcount, perc, scores, stddev);
...
//  npos = 4;
//
//  /*avals = (int*)malloc(asize*sizeof(int));
//  if (avals == NULL) {
//    printf("avals is null\n");
//    exit(1);
//  }
//
//  bvals = (int*)malloc(bsize*sizeof(int));
//  if (bvals == NULL) {
//    printf("bvals is NULL \n");
//    exit(1);
//    }*/
//
...
//  printf("\n");*/
//
//  int Avals[20] = {1,2,1,2,1,0,0,1,1,2,1,2,0,0,1,1,1,1,1,1};
//  int Bvals[20] = {1,0,0,0,1,2,3,2,3,1,1,1,2,2,3,0,1,0,1,0};
//  int *f = (int*)malloc(4*sizeof(int));
//
//  /* test */
//  printf("before fet\n");
//  fisher_exact_test(results, (int*)Avals, (int*)Bvals, asize, bsize, npos, f);
//  printf("%g %g\n", results[0], results[1]);
//
//  free(results);
//  free(f);

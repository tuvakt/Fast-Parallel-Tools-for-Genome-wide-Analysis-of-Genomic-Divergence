...
import time, re, os, sys, calendar
...
class ClusterSeparationScore(GeneralGuiTool):
    @staticmethod
    def getToolName():
        '''
        ...
        page.
        '''
        return "Calculate cluster separation score :)"
    ...
    def getInputBoxNames():
        ...
        '''
        return ['Reference genome', 'Group 1 SNPs', "Group 2 SNPs","Pairwise individual comparison metric", "Multi-Dimensional Scaling method", "Sliding Window Size", "Sliding Window Step",  "Minimum significance score runs", "Maximal significance scores", "Output format"] #Alternatively: [ ('box1','1'), ('box2','2') ]
    ...
    def getOptionsBox4(self): # Alternatively: getOptionsBoxKey()
        return ["Count individual SNP-differences in window", "Compute average of difference in minor allele frequency for grouped SNPs"]

    @staticmethod
    def getOptionsBox5(self):
        return ["Classical MDS", "SMACOF", "SMACOF + Classical MDS"]
    
    @staticmethod    
    def getOptionsBox6(self): # Alternatively: getOptionsBoxKey()
        return '2500'

    @staticmethod    
    def getOptionsBox7(self): # Alternatively: getOptionsBoxKey()
        return '500'
    
    @staticmethod    
    def getOptionsBox8(self): # Alternatively: getOptionsBoxKey()
        return '10'
    
    @staticmethod    
    def getOptionsBox9(self): # Alternatively: getOptionsBoxKey()
        return '200000'
    
    @staticmethod
    def getOptionsBox10(self):
        return ["tabular", "html"]
    #@staticmethod
    ...
    def validateAndReturnErrors(choices):
        ...
        try:
            ...
            return "Only integers allowed for window size, window step and maximum/minimum amount of significance simulations"

        if int(choices[8]) < int(choices[7]):
            return "Maximum amount significance runs cannot be less than minimum runs"

        if choices[1] == None or choices[2] == None:
    ...
    #    '''
        return '<h2>FAQ</h2><h3>What is the aim of this tool?</h3><br />This tool scores the genomic divergence between two population in sliding windows of the genome based on SNP-data. Higher scores means larger divergence. P-values of scores are calculated as well, for easier post-processing into genomic regions.<br /><br /><h3>How do I format the SNP data for use in this tool?</h3><br /> The headers needed for gtrack files using this tool are:<ul><li>seqid, denoting the chromosome</li><li>start, denoting the position of the SNP</li><li>Value, denoting either the minor allele frequency or the specific individual value for the SNP (3:major, -3: minor, 0:both observed/other, -10000:Not validated)</li><li>genomeid, identifying which individual/population the particular line represents</li></ul>An example of this is:<br />###gtrack version: 1.0<br />##track type: valued points<br/>\
##value type: category<br/>\
###seqid	start	value	genomeid<br/>\
####genome=gasAcu1<br/>\
chrVII	104	-3	0<br/><br /> <h3>What does the different fields mean?</h3><br/>Write about the fields here <br/><br/><h3>Has this tool been used before?</h3><br />For example cases see this page for analysis done on three-spine marine-freshwater sticklebacks and this page for drosophila melanogaster-analyses. <br /><br /><h3>How to find the regions with highest genomic divergence?</h3><br />The output can be filtered into significant regions of divergence using the "Significant Css Regions"-tool'
    #
    #@staticmethod
